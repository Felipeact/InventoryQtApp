...
MD_FILE = HERE / "StockPilot-Desktop-UI-Redesign-Plan.md"
CSS_FILE = HERE / "style.css"
OUT_FILE = HERE / "StockPilot-Desktop-UI-Redesign-Plan.pdf"

COVER = """
<div class="cover">
  <div class="glyph">◆</div>
  <h1>StockPilot — Desktop UI/UX<br>Redesign Plan</h1>
  <div class="sub">An API‑driven, role‑aware redesign of the Qt desktop client, aligned with
  the StockPilot web app: navigation, page‑by‑page layout, component library, user flows,
